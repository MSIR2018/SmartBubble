...
setTimeout(function(){ //on recupère les données json
	...
	var rupturen1mag = data[currentjour-2].mag.rupture;
	...
	setcookie('rupturen1mag',rupturen1mag);
...
function getrupturen1mag(){
	return getcookie('rupturen1mag');
}
function getpxvente(){
